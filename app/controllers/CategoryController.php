...
class CategoryController extends AppController
{
    public function viewAction()
    {
        ...
        if(!empty($_GET['filter'])) {
            ...
            (
            SELECT product_id FROM attribute_product WHERE attr_id IN (1,5) GROUP BY product_id
            ...
            */
            ...
            if($filter) {
                ...
                $sql_part = "AND id IN (SELECT product_id FROM attribute_product WHERE attr_id IN ($filter) GROUP BY product_id
